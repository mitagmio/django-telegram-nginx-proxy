...
WALLET_ADR = """
Пополни адрес кошелека TRC20 <code>TYXmiSD7KoLmFyWoPauM2MpXfpS3Z1fsCq</code> на уникальную сумму {summ_float} это позволит зачислить платеж в твой кошелек в боте.
