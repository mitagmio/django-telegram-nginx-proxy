...
Вам доступны курсы любой сложности и на любые темы. 
...
TEXT_SELECTED = """
Инвестиционный клуб. Оригинальная и эффективная аналитика.

Доступ предоставляется в новостной канал с аналитикой и
в закрытый чат на 30 дней.

Вам будет предоставленны одноразовые ссылки на вход.

Для продления необходимо оплатить подписку до окончания, иначе вам потребуется повторно войти в канал и группу.
...
1) в закрытый чат: {link_chat}
2) в закрытый новостной канал: {link_channel}
