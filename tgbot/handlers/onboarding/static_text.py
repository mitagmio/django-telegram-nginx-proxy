...
После зачисления придёт уведомление от бота и вы сможете приобрести один из продуктов
"""
...
1) в закрытый новостной канал(ссылка активна 24ч, выступайте сразу): {link_channel}
