...
MENU = """
<b>OM DAO Venture</b> - здесь мы инвестируем в перспективные проекты на ранней стадии. 
...
Стоимость подписки:
🔵30 дней - 200 usdt
🔵90 дней - 300 usdt (Скидка 50% от стандартной цены.)
...
3) Заполните эту <a href="https://forms.gle/DigYDnz16p1ucheM6">гугл-форму</a> (клик) для получения доступа в Notion
4) Предлагаем вам также подучить английский в <a href="https://twitter.com/SELECTED_LAB">нашем новостном Твиттере</a> (клик)
